...
<body>
    <header>
        <div class="navbar">
            ...
            <!-- make one user profile circle than on click show the profile and logout buttons -->
            <div class="auth-links" id="authLinks">
                <?php if ($alumni_id && isset($alumni_id)): ?>
                    <a href="./alumni_dashboard.php" class="btn btn-outline">Profile</a>
                    <a href="../logout.php" class="btn btn-outline">Logout</a>
                <?php else: ?>
                    <a href="../login.php" class="btn btn-outline">Login</a>
                    <a href="./alumni_register.php" class="btn btn-solid">Register</a>
                <?php endif; ?>
            </div>
